...
class GCM {
	...
	#if android
		openfl.utils.JNI.createStaticMethod("gcmex/GCM", "getRegistrationId_Static", "()Ljava/lang/String;");
	#else
	...
	#if android
		openfl.utils.JNI.createStaticMethod("gcmex/GCM", "init", "(Ljava/lang/String;)V");
	#else
	...
	#if android
		openfl.utils.JNI.createStaticMethod("gcmex/GCM", "sendMessage", "(Ljava/lang/String;)V");
	#else
